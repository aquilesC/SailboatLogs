    ...
    def handle(self, *args, **options):
        ...
        for gpx_record in gpx_files:
            ...
            try:
                ...
                distance_nm = (
                    moving_data.moving_distance * 0.000539957
                    if moving_data.moving_distance
                    else 0.0
                )
                max_speed_kn = (
                    moving_data.max_speed * 1.94384 if moving_data.max_speed else 0.0
                )

                old_points = (
                    len(gpx_record.track_points) if gpx_record.track_points else 0
                )
